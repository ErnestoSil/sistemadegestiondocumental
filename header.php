    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="home.php" class="logo"><!-- Logo -->
                <span class="logo-mini"><b>TecNMCampus</b>Tepeaca</span>
                <span class="logo-lg"><b>TecNMCampus</b>Tepeaca</span> 
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="user-header"><!-- User image -->
                                    ...
                                    <p>
                                      <?php echo $fullname; ?>
                                      <small>Fecha de registro  <?php $created_at=date('d/M/Y', strtotime($created_at)); echo $created_at ?></small>
                                    </p>
                                </li>
